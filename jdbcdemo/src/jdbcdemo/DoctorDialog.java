...
public class DoctorDialog extends JDialog {
	...
	private DoctorSearchApp doctorSearchApp;
	
	private Doctor previousDoctor = null;
	private boolean updateMode = false;
	
	public DoctorDialog(DoctorSearchApp theDoctorSearchApp, Driver theDriver, Doctor thePreviousDoctor, boolean theUpdateMode){
		this();
		driver = theDriver;
